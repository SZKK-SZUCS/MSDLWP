...
class MSDL_Widget_File_Manager extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        <style>
            ...
            .msdl-fm-breadcrumbs a:hover { background: rgba(0,0,0,0.06); }
            .msdl-fm-breadcrumbs span.msdl-fm-sep { color: #a0a6b5; margin: 0 2px; }
            .msdl-fm-breadcrumbs span.msdl-fm-current { font-weight: 700; padding: 6px 10px; }
            
            .msdl-fm-search { position: relative; width: 280px; max-width: 100%; margin-left: auto; }
            .msdl-fm-search input { width: 100%; padding: 10px 15px 10px 38px; border: 1px solid #dcdcde; border-radius: 6px; font-size: 14px; box-sizing: border-box; transition: border-color 0.2s; background: #fff; }
            .msdl-fm-search input:focus { outline: none; }
            .msdl-fm-search i { position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: #a0a6b5; font-size: 14px; }
            
            .msdl-fm-body { position: relative; width: 100%; overflow-x: auto; min-height: 250px; }
            .msdl-fm-loader { position: absolute; top:0; left:0; width:100%; height:100%; background: rgba(255,255,255,0.9); display: flex; flex-direction: column; gap: 15px; align-items: center; justify-content: center; font-weight: 600; font-size: 15px; z-index: 10; display: none; backdrop-filter: blur(3px); }
            .msdl-fm-spinner { border: 3px solid rgba(0,0,0,0.1); width: 36px; height: 36px; border-radius: 50%; border-left-color: currentColor; animation: msdl-spin 0.8s linear infinite; }
            ...
            .msdl-col-action { white-space: nowrap; width: 120px; text-align: right; }

            .msdl-fm-item-name { display: flex; align-items: center; gap: 14px; font-weight: 600; cursor: pointer; text-decoration: none !important; transition: all 0.2s; line-height: 1.4;}
            ...
            @media (max-width: 768px) {
                ...
                .msdl-fm-btn, .msdl-fm-btn-outline { width: 100%; justify-content: center; margin-left: 0; margin-bottom: 10px;}
            }
        </style>
        ...
        jQuery(document).ready(function($) {
                    ...
                    if (response.success) {
                        ...
                        itemsToRender.forEach(function(item) {
                            ...
                            if (item.type === 'folder') {
                                ...
                                actionHtml = '<a class="msdl-fm-btn msdl-fm-file-link" data-id="'+item.id+'">Megtekintés</a>';
                            }
            ...
            function loadFile(fileId) {
                ...
                $wrapper.find('.msdl-loader-text').text('Fájl adatlap lekérése...');
                $wrapper.find('.msdl-fm-loader').css('display', 'flex');
                ...
                $.post(ajaxUrl, {
                    ...
                    if (response.success) {
                        ...
                        if (fvShowDownload) {
                            actionsHtml += '<a href="'+data.download_url+'" target="_blank" class="msdl-fm-btn"><svg style="width:14px;height:14px;fill:currentColor;" viewBox="0 0 512 512"><path d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32V274.7l-73.4-73.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L288 274.7V32zM64 352c-35.3 0-64 28.7-64 64v32c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V416c0-35.3-28.7-64-64-64H346.5l-45.3 45.3c-25 25-65.5 25-90.5 0L165.5 352H64zm368 56a24 24 0 1 1 0 48 24 24 0 1 1 0-48z"/></svg> Letöltés</a>';
                        }
                        if (fvShowCopy) {
